          ...
          <div style="padding: 25px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-top: 10px;">
              ...
              <tr>
                ...
                } ${product.price.basePrice * qty}</td>
              </tr>
            </table>
            ...
            <div style="margin-top: 30px; text-align: center;">
              <a href="${
                product.slug || "#"
              }" style="background: #16a085; color: #fff; padding: 12px 20px; text-decoration: none; border-radius: 5px;">View Booking</a>
            </div>
          </div>
...
export function isMasterOTP(entered) {
